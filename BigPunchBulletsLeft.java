...
/**
 * Write a description of class BigPunchBulletsLeft here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class BigPunchBulletsLeft extends Projectiles
{
    public static boolean bulletIsTouched =  false;
    /**
     * Act - do whatever the BigPunchBulletsLeft wants to do. This method is called whenever
