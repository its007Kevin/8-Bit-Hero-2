...
/**
 * Write a description of class DeepBall1 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DeepBall1Right extends Projectiles
{
    /**
     * Act - do whatever the DeepBall1 wants to do. This method is called whenever
    ...
    private void deepBall1Animation(){
        if(timer.millisElapsed()>100)setImage("fireballr2.png");
        if(timer.millisElapsed()>200)setImage("fireballr3.png");
        if(timer.millisElapsed()>300)setImage("fireballr4.png");
